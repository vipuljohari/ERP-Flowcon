...
const DataManagement: React.FC<DataManagementProps> = ({ 
  ...
  const handlePushToCloud = async (provider: 'gdrive' | 'dropbox') => {
    setIsSyncing(true);
    try {
      const data = { parts, sales, inwardLogs, archives, customers, rawMaterials, rmInwardLogs, localRMOpeningBalances, timestamp: new Date().toISOString(), lastModifiedBy: userName };
